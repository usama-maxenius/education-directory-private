export const ProgressBar = ({ colour }) => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="44" height="44" viewBox="0 0 44 44">
            ...
            <g id="Group_431" data-name="Group 431" transform="translate(-602 -135)">
                <g transform="matrix(1, 0, 0, 1, 602, 135)" filter="url(#Ellipse_48)">
                    <circle 
                        id="Ellipse_48-2" 
                        data-name="Ellipse 48" cx="13" cy="13" r="13" 
...
export const ArrowChevronIcon = ({ colour, rotate }) => {
    return(
        <svg id="arrow_back_ios_black_24dp" 
            xmlns="http://www.w3.org/2000/svg" 
            width="19.987" height="19.987" viewBox="0 0 19.987 19.987"
